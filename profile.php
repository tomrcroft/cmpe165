        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <div class="wow bounceInDown" data-wow-delay="0.4s">
                    ...
                    ?>
                    <form name="input" action="profile.php#profile" method="post">
                        <input type="submit" value="Edit Profile" name="submitEdit">
                        
                    </form>
                    <br>
                    <?php
                    if (isset($_POST["submitEdit"])) {
                        print "<form name=\"edit\" acction=\"profile.php#profile\" method=\"post\">
                        <P>
                            Your new Full Name:
                                ...
                                <div class="col-md-12 control">
                                    <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" > Don't have an account? 
                                        <a href="#" onClick="$('#loginbox').hide();
                                                $('#signupbox').show()"> Register Here</a>
                                    </div>
                                </div>
                            </div>   
                ...
                <div class="panel-heading">
                    ...
                    <div style="float:right; font-size: 85%; position: relative; top:-10px">
                        <a id="signinlink" href="#" onclick="$('#signupbox').hide();
                                $('#loginbox').show()">Or Login Here</a></div>
                </div>
